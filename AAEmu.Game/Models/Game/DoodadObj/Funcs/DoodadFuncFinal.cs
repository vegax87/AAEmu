...
namespace AAEmu.Game.Models.Game.DoodadObj.Funcs
{
    public class DoodadFuncFinal : DoodadPhaseFuncTemplate
    {
        ...
        {
            _log.Trace("DoodadFuncFinal: TemplateId {0}, After {1}, Respawn {2}, MinTime {3}, MaxTime {4}, ShowTip {5}, ShowEndTime {6}, Tip {7}",
                owner.TemplateId, After, Respawn, MinTime, MaxTime, ShowTip, ShowEndTime, Tip);
            ...
            else
            {
                ...
                {
                    //owner.Spawner.DecreaseCount(owner); // ToDo нельзя использовать, вызывает бесконечный респавн!!!
