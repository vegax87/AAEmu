...
{
    public class SCUnknownPacket_0x0A0 : GamePacket
    {
        ...
        public SCUnknownPacket_0x0A0(SlotType slotType, byte slot, SlotType slotType2, byte slot2, short errorMessage) : base(SCOffsets.SCUnknownPacket_0x0A0, 5)
        {
            _slotType = slotType;
            _slot = slot;
